...
mean(m1_baseline_survey_parts$overall_pr_ill_mean)

m1_baseline_suvey_parts_confidence_intervals <- rbind(
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_noncompliant_1_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_noncompliant_2_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_noncompliant_3_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_compliant_1_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_compliant_2_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_compliant_3_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_3_noncompliant_product_mean)
)
m1_baseline_survey_parts_confidence_intervals <- data.frame(m1_baseline_survey_parts_confidence_intervals)
colnames(m1_baseline_survey_parts_confidence_intervals) <- c("ci_5pc", "ci_95pc")
m1_baseline_survey_parts_specifics <- cbind(m1_baseline_survey_parts_specifics, m1_baseline_survey_parts_confidence_intervals)
m1_baseline_survey_parts_specifics <- rbind(m1_baseline_suvey_parts_specifics, c("Baseline", NA, 1, 89969366913, mean(m1_baseline_survey_parts$overall_pr_ill_mean), 1, confidence_interval(m1_baseline_survey_parts$overall_pr_ill_mean)))

write.csv(m1_baseline_survey_parts_specifics, "m1_baseline_result_subset_with_CI.csv", row.names = FALSE)
...
mean(m2_baseline_survey_parts$overall_pr_ill_mean)

m2_baseline_suvey_parts_confidence_intervals <- rbind(
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_noncompliant_1_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_noncompliant_2_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_noncompliant_3_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_compliant_1_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_compliant_2_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_compliant_3_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_inclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_exclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m2_baseline_survey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_3_noncompliant_product_mean)
)
m2_baseline_survey_parts_confidence_intervals <- data.frame(m2_baseline_survey_parts_confidence_intervals)
colnames(m2_baseline_survey_parts_confidence_intervals) <- c("ci_5pc", "ci_95pc")
m2_baseline_survey_parts_specifics <- cbind(m2_baseline_survey_parts_specifics, m2_baseline_survey_parts_confidence_intervals)
m2_baseline_survey_parts_specifics <- rbind(m2_baseline_suvey_parts_specifics, c("Baseline", NA, 1, 89969366913, mean(m2_baseline_survey_parts$overall_pr_ill_mean), 1, confidence_interval(m2_baseline_survey_parts$overall_pr_ill_mean)))

write.csv(m2_baseline_survey_parts_specifics, "m2_baseline_result_subset_with_CI.csv", row.names = FALSE)
...
mean(m1_baseline_survey_parts$pr_ill_from_compliant_1_product_mean)
...
m1_new_haccp_1e5 <- poultry_model_clustered(1e5, 10, 12, 1, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000016, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp")
m1_new_haccp_1e5_specifics <- get_table_values(m1_new_haccp_1e5)
m1_new_haccp_1e5_confidence_intervals <- rbind(
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_noncompliant_1_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_noncompliant_2_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_noncompliant_3_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_compliant_1_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_compliant_2_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_compliant_3_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_inclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_inclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_inclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_exclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_not_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_not_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_new_haccp_1e5$pr_ill_from_not_exclusion_list_and_level_based_mc_3_noncompliant_product_mean)
)
m1_new_haccp_1e5_confidence_intervals <- data.frame(m1_new_haccp_1e5_confidence_intervals)
colnames(m1_new_haccp_1e5_confidence_intervals) <- c("ci_5pc", "ci_95pc")
m1_new_haccp_1e5_specifics <- cbind(m1_new_haccp_1e5_specifics, m1_new_haccp_1e5_confidence_intervals)
m1_new_haccp_1e5_specifics <- rbind(m1_new_haccp_1e5_specifics, c("Baseline", NA, 1, 89969366913, mean(m1_new_haccp_1e5$overall_pr_ill_mean), mean(m1_new_haccp_1e5$annual_predicted_illnesses), 1, mean(m1_new_haccp_1e5$overall_pr_ill_mean),  confidence_interval(m1_new_haccp_1e5$overall_pr_ill_mean)))

# ci_t1<-confidence_interval(m1_new_haccp$pr_ill_from_noncompliant_1_product_mean)*mean(m1_new_haccp$proportion_noncompliant_with_mc_1)*mean(m1_new_haccp$annual_servings)

write.csv(m1_new_haccp_1e5_specifics, "M1_1E5_result_subset_with_CI.csv", row.names = FALSE)

mean(m1_new_haccp_1e5$overall_pr_ill_mean)
```
...
m1_baseline_suvey_parts <- poultry_model_clustered(1e6, 10, 12, 2, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000050, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp")
m1_baseline_suvey_parts_specifics <- get_table_values(m1_baseline_suvey_parts)

m1_baseline_suvey_parts_specifics <- get_table_values(m1_baseline_suvey_parts)
m1_baseline_suvey_parts_confidence_intervals <- rbind(
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_noncompliant_1_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_noncompliant_2_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_noncompliant_3_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_compliant_1_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_compliant_2_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_compliant_3_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_inclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_inclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_inclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_exclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m1_baseline_suvey_parts$pr_ill_from_not_exclusion_list_and_level_based_mc_3_noncompliant_product_mean)
)
m1_baseline_suvey_parts_confidence_intervals <- data.frame(m1_baseline_suvey_parts_confidence_intervals)
colnames(m1_baseline_suvey_parts_confidence_intervals) <- c("ci_5pc", "ci_95pc")
m1_baseline_suvey_parts_specifics <- cbind(m1_baseline_suvey_parts_specifics, m1_baseline_suvey_parts_confidence_intervals)
m1_baseline_suvey_parts_specifics <- rbind(m1_baseline_suvey_parts_specifics, c("Baseline", NA, 1, 89969366913, mean(m1_baseline_suvey_parts$overall_pr_ill_mean), 1, confidence_interval(m1_baseline_suvey_parts$overall_pr_ill_mean)))

write.csv(m1_baseline_suvey_parts_specifics, "m2_result_subset_with_CI.csv", row.names = FALSE)
...
m3_new_haccp_specifics <- get_table_values(m3_new_haccp)
m3_new_haccp_confidence_intervals <- rbind(
  confidence_interval(m3_new_haccp$pr_ill_from_noncompliant_1_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_noncompliant_2_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_noncompliant_3_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_compliant_1_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_compliant_2_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_compliant_3_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_inclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_inclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_inclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_exclusion_list_and_level_based_mc_3_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_not_exclusion_list_and_level_based_mc_1_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_not_exclusion_list_and_level_based_mc_2_noncompliant_product_mean),
  confidence_interval(m3_new_haccp$pr_ill_from_not_exclusion_list_and_level_based_mc_3_noncompliant_product_mean)
)
m3_new_haccp_confidence_intervals <- data.frame(m3_new_haccp_confidence_intervals)
colnames(m3_new_haccp_confidence_intervals) <- c("ci_5pc", "ci_95pc")
m3_new_haccp_specifics <- cbind(m3_new_haccp_specifics, m3_new_haccp_confidence_intervals)
m3_new_haccp_specifics <- rbind(m3_new_haccp_specifics, c("Baseline", NA, 1, 89969366913, mean(m3_new_haccp$tdr_mean_pr_ill), 1, confidence_interval(m3_new_haccp$tdr_mean_pr_ill)))
mean(m3_new_haccp$tdr_mean_pr_ill)

write.csv(m3_new_haccp_specifics, "m3_result_subset_with_CI_Final0416.csv", row.names = FALSE)

```

```{r}
# file_root <- paste0(getwd(), "/outputs/Final/New_HACCP_more_M3/2024-04-16-10-10-55_new_haccp_M3_1E+06")
file_root <- paste0(getwd(), "/outputs/Final/Baseline_M3/2024-04-16-17-26-37_baseline_survey_parts_M3_1E+06")

m3_pull <- data.table::fread(paste0(file_root, "_1_of_10_clean.csv"))$tdr_mean_pr_ill
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_2_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_3_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_4_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_5_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_6_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_7_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_8_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_9_of_10_clean.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_10_of_10_clean.csv"))$tdr_mean_pr_ill)
mean(m3_pull)
```

```{r}
# file_root <- paste0(getwd(), "/outputs/Final/New_HACCP_more_M3/2024-04-16-10-10-55_new_haccp_M3_1E+06")
file_root <- paste0(getwd(), "/outputs/Final/New_HACCP_more_M1/2024-04-17-10-42-12_new_haccp_M1_1E+06")

m3_pull <- data.table::fread(paste0(file_root, "_1_of_10.csv"))$tdr_mean_pr_ill
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_2_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_3_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_4_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_5_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_6_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_7_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_8_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_9_of_10.csv"))$tdr_mean_pr_ill)
m3_pull <- c(m3_pull, data.table::fread(paste0(file_root, "_10_of_10.csv"))$tdr_mean_pr_ill)
mean(m3_pull)
```
