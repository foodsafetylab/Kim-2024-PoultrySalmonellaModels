...
# serotype_parameters <- readxl::read_xlsx("Serotype_Parameters.xlsx", sheet = "Sheet1") # WHO/FAO (2002)
...
m1_baseline_survey_parts <- poultry_model_clustered(1e6, 10, 12, 1, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0001175, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="baseline_survey_parts")
...
```
```{r Unified Poultry Function - Baseline Survey 2012 (Parts) - M2 - SF1}
salmonella_mean <- -3.19 # Baseline Survey 2012 (Parts)
salmonella_st_dev <- 1.29 # Baseline Survey 2012 (Parts)
...
m2_baseline_survey_parts <- poultry_model_clustered(1e6, 10, 12, 2, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00014, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="baseline_survey_parts")
m2_baseline_survey_parts_specifics <- get_table_values(m2_baseline_survey_parts)
```
```{r Unified Poultry Function - Baseline Survey 2012 (Parts) - M2 - SF2}
salmonella_mean <- -3.19 # Baseline Survey 2012 (Parts)
salmonella_st_dev <- 1.29 # Baseline Survey 2012 (Parts)
...
m2_baseline_survey_parts <- poultry_model_clustered(1e6, 10, 12, 2, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00016, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="baseline_survey_parts")
m2_baseline_survey_parts_specifics <- get_table_values(m2_baseline_survey_parts)
```
...
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data

product_consumed_per_individual_per_day_mean <- 2.06 # CDC 2016, Lambertini  et al. (2019)
product_consumed_per_individual_per_day_st_dev <- 0.23 # CDC 2016, Lambertini  et al. (2019)

m1_new_haccp <- poultry_model_clustered(1e6, 10, 12, 1, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000035, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp")
...
m2_new_haccp <- poultry_model_clustered(1e6, 10, 12, 2, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000050, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp")
m2_new_haccp_specifics <- get_table_values(m2_new_haccp)
```
...
m3_new_haccp <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.000000035, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp")
m3_new_haccp_specifics <- get_table_values(m3_new_haccp)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF1}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf1 <- poultry_model_clustered(1e4, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000002, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF1")
m3_new_haccp_sf1_specifics <- get_table_values(m3_new_haccp_sf1)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF2}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf2 <- poultry_model_clustered(1e4, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000018, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF2")
m3_new_haccp_sf2_specifics <- get_table_values(m3_new_haccp_sf2)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF3}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf3 <- poultry_model_clustered(1e4, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000019, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF3")
m3_new_haccp_sf3_specifics <- get_table_values(m3_new_haccp_sf3)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF4}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf4 <- poultry_model_clustered(1e3, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000185, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF4")
m3_new_haccp_sf4_specifics <- get_table_values(m3_new_haccp_sf4)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF5}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf5 <- poultry_model_clustered(1e3, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.000001825, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF5")
m3_new_haccp_sf5_specifics <- get_table_values(m3_new_haccp_sf5)
```
...
m3_new_haccp_sf4 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000185, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF4")
m3_new_haccp_sf4_specifics <- get_table_values(m3_new_haccp_sf4)
```
...
m3_new_haccp_sf5 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000015, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF5")
m3_new_haccp_sf5_specifics <- get_table_values(m3_new_haccp_sf5)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF6}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf6 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.0000001, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF6")
m3_new_haccp_sf6_specifics <- get_table_values(m3_new_haccp_sf6)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF7}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf7 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000005, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF7")
m3_new_haccp_sf7_specifics <- get_table_values(m3_new_haccp_sf7)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF8}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf8 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000004, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF8")
m3_new_haccp_sf8_specifics <- get_table_values(m3_new_haccp_sf8)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF9}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf9 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.00000003, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF9")
m3_new_haccp_sf9_specifics <- get_table_values(m3_new_haccp_sf9)
```

```{r Unified Poultry Function - New HACCP Data - M3 - SF10}
salmonella_mean <- -4.85 # New HACCP Data
salmonella_st_dev <- 2.44 # New HACCP Data
...
m3_new_haccp_sf10 <- poultry_model_clustered(1e6, 10, 12, 3, serotype_probabilities, serotype_equivalents, salmonella_mean, salmonella_st_dev, 0.000000035, product_consumed_per_individual_per_day_mean, product_consumed_per_individual_per_day_st_dev, 89969366913.2337, teunis_dose_response, tuenis_submodel_parameters, pr_ill_from_dose, poultry_model, save_runs = TRUE, comment="new_haccp_SF10")
m3_new_haccp_sf10_specifics <- get_table_values(m3_new_haccp_sf10)
```

```{r}
file <- "2024-01-10-10-42-17_new_haccp_M2_1E+06"
M2_X <- read.csv(paste0(getwd(), "/outputs/", file, "_1_of_10.csv"))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_2_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_3_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_4_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_5_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_6_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_7_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_8_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_9_of_10.csv")))$overall_pr_ill
M2_X <- c(M2_X, read.csv(paste0(getwd(), "/outputs/", file, "_10_of_10.csv")))$overall_pr_ill
mean(M2_X)
```
